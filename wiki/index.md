...
원문: [프로젝트 브리프](../raw/project-brief.md), [홈 화면 참고 이미지](../raw/home/home_reference.png), [홈 화면 에셋](../raw/home/), [성장 선택 카드 참고 이미지](../raw/references/upgrade-choice-cards.png), [슬라임 스탯·가격·패널티](../raw/slime-stats-pricing-and-penalties.md), [펀테스트 변경 사항](../raw/fun-test-design-changes.md), [음성인식 시스템 논의](../raw/voice-command-discussion-summary-revised.md)
